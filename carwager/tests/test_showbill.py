...
class TestShowbill:
    def test_adverts_view(self):
        ...
        Advert.objects.create(car=car, engine_type="Test", engine_capacity=random.randint(1, 10),
                              ...
                              price=random.randrange(9999999999999), price_usd=random.randrange(9999999999999),
                              owner=user, phone_number=random.randrange(9999999), )
